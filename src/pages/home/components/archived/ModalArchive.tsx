...
import { StyleModalArchive } from './styleModalArchive';
...
const ModalArchive: React.FC<PropsModal> = ({ openModal, clickCancel, closeModal, children }) => {
            ...
            >
                <StyleModalArchive>
                    <Box>
                        ...
                        <div className='textTitleEdit'> - TAREFAS ARQUIVADAS - </div>
